     ...
     try {
        const response = await ai.models.generateContent({
            ...
            config: {
                ...
                responseSchema: SCHEMAS.taskPlan
            }
        });
...
export const generateOptimizePlan = async (goal: string): Promise<OptimizePlan | null> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: {
                responseMimeType: "application/json",
                responseSchema: SCHEMAS.optimizePlan
            }
        });
...
export const generateSyntaxHighlighting = async (code: string, fileName: string): Promise<HighlightedLine[] | null> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.highlightedLineArray }
        });
...
export const generateExplanation = async (command: string): Promise<Explanation | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.explanation }
        });
...
export const generateCommitMessage = async (diff: string): Promise<ConventionalCommit | null> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.conventionalCommit }
        });
...
Please generate a new, corrected plan to achieve the original goal, taking the failure into account. Provide a JSON object of type TaskPlan.` }] }],
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.taskPlan }
        });
...
export const analyzeSystemHealth = async (context: any): Promise<HealthReport | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.healthReport }
        });
...
export const analyzeAiUsage = async (stats: any): Promise<AiUsageReport | null> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.aiUsageReport }
        });
...
export const suggestEvolution = async (history: string[]): Promise<EvolutionSuggestion | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.evolutionSuggestion }
        });
...
export const analyzePermissions = async (lsOutput: string): Promise<SecurityReport | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.securityReport }
        });
...
export const critiqueScript = async (scriptContent: string): Promise<CritiqueReport | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.critiqueReport }
        });
...
export const summarizeGitHistory = async (log: string): Promise<GitDigestReport | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.gitDigestReport }
        });
...
export const explainConcept = async (concept: string): Promise<LearningReport | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.learningReport }
        });
...
LOG:
${log}` }] }],
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.journalReport }
        });
...
export const generateSystemReport = async (data: any): Promise<SystemReport | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.systemReport }
        });
...
export const documentScript = async (scriptContent: string): Promise<ScriptDocumentation | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.scriptDocumentation }
        });
...
export const analyzeIntent = async (prompt: string): Promise<IntentAnalysis> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.intentAnalysis }
        });
...
export const suggestOrganization = async (fileList: string): Promise<OrganizationPlan | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.organizationPlan || { type: Type.OBJECT, properties: { commands: { type: Type.ARRAY, items: { type: Type.STRING } } } } }
        });
...
${JSON.stringify(trace, null, 2)}` }] }],
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.debugReport || undefined }
        });
...
export const getDiagnosticCommands = async (problem: string): Promise<TroubleshootingStep[] | null> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.troubleshootingStepArray }
        });
...
export const diagnoseProblem = async (problem: string, data: any[]): Promise<TroubleshootingReport | null> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.troubleshootingReport }
        });
...
export const summarizeHistory = async (history: string[]): Promise<HistoryDigestReport | null> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.historyDigestReport }
        });
...
export const performSystemAudit = async (data: any): Promise<AuditReport | null> => {
    try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.auditReport }
        });
...
export const scanPorts = async (hostname: string): Promise<PortScanReport | null> => {
     try {
        const response = await ai.models.generateContent({
            ...
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.portScanReport }
        });
...
${contents}` }] }],
            config: { responseMimeType: "application/json", responseSchema: SCHEMAS.explainResult }
        });
...
INPUT:\n${input.slice(0, 8000)}` }] }],
            config: { responseMimeType: 'application/json', responseSchema: SCHEMAS.summarizeResult }
        });
...
HISTORY:\n${JSON.stringify(history, null, 2)}` }] }],
            config: { responseMimeType: 'application/json', responseSchema: SCHEMAS.suggestionItemArray }
        });
        return safelyParseJson<SuggestionItem[]>(response.text, (e) => console.error('Failed to parse SuggestionItem[] JSON:', response.text, e));
    } catch (e) { console.error(e); return null; }
};

export const generateImprovementPlan = async (feedback: FeedbackEntry[], usageLog: string[]): Promise<ImprovementPlan | null> => {
    try {
        const response = await ai.models.generateContent({
            model: 'gemini-2.5-flash',
            contents: [{ role: 'user', parts: [{ text: `Analyze the following end-user feedback entries and usage logs. Produce a concise ImprovementPlan in JSON that prioritizes actions, notes if consent is required for any step, and suggests rollback metadata where applicable.\n\nFEEDBACK:\n${JSON.stringify(feedback, null, 2)}\n\nUSAGE_LOG:\n${JSON.stringify(usageLog, null, 2)}` }] }],
            config: { responseMimeType: 'application/json', responseSchema: SCHEMAS.improvementPlan }
        });
        return safelyParseJson<ImprovementPlan>(response.text, (e) => console.error('Failed to parse ImprovementPlan JSON:', response.text, e));
    } catch (e) {
        console.error(e);
        return null;
    }
